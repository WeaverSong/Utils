...
var _CanvasRenderer_instances, _CanvasRenderer_SetValues;
;
;
class CanvasRenderer {
    ...
    Settings(Settings) {
        ...
        if (((_a = Settings.size) === null || _a === void 0 ? void 0 : _a.width) && ((_b = this.settings.size) === null || _b === void 0 ? void 0 : _b.width) !== Settings.size.width)
            this.canvas.width = Settings.size.width;
        if (((_c = Settings.size) === null || _c === void 0 ? void 0 : _c.height) && ((_d = this.settings.size) === null || _d === void 0 ? void 0 : _d.height) !== Settings.size.height)
            this.canvas.height = Settings.size.height;
        for (let key in Settings) {
            this.settings[key] = Settings[key];
        }
        __classPrivateFieldGet(this, _CanvasRenderer_instances, "m", _CanvasRenderer_SetValues).call(this, this.settings);
    }
    ;
    ;
    ...
    Shadow(Settings, i) {
        ...
        for (let key in this.settings.shadow) {
            if (Settings[key] === undefined)
                Settings[key] = this.settings.shadow[key];
        }
    ...
    */
    Line(Settings, i) {
        ...
        for (let key in this.settings.line) {
            if (Settings[key] === undefined)
                Settings[key] = this.settings.line[key];
        }
    ...
    */
    Rotation(Settings, i) {
        ...
        if (!i)
            this.settings.rotation = Settings;
    }
    ;
    ...
    */
    TextAlign(Settings, i) {
        ...
        if (!i)
            this.settings.textAlign = Settings;
    }
    ;
    ...
    */
    TextBaseLine(Settings, i) {
        ...
        if (!i)
            this.settings.textBaseLine = Settings;
    }
    ;
    ...
    */
    CompositeOperation(Settings, i) {
        if (Settings === undefined)
            return this.settings.compositeOperation;
        this.ctx.globalCompositeOperation = Settings;
        if (!i)
            this.settings.compositeOperation = Settings;
    }
    ;
    ...
    */
    MaxTextWidth(Settings) {
        if (Settings === undefined)
            return this.settings.maxTextWidth;
    ...
    */
    ImageClipping(Settings) {
        if (Settings === undefined)
            return this.settings.imageClipping;
        if (this.settings.imageClipping === undefined)
            throw new Error("imageClipping became undefined! You did something wrong. This error can't happen, only exists for typescript's being stupid and my being lazy.");
        if (Settings.x !== undefined)
            this.settings.imageClipping.x = Settings.x;
        if (Settings.y !== undefined)
            this.settings.imageClipping.y = Settings.y;
        if (Settings.width !== undefined)
            this.settings.imageClipping.width = Settings.width;
        if (Settings.height !== undefined)
            this.settings.imageClipping.height = Settings.height;
    }
    ;
    ...
    */
    DrawShape(Positions, Settings) {
        __classPrivateFieldGet(this, _CanvasRenderer_instances, "m", _CanvasRenderer_SetValues).call(this, Settings);
    ...
    */
    DrawImage(Img, Position = { x: 0, y: 0 }, Settings) {
        ...
        if (c.x === undefined || c.y === undefined || c.width === undefined || c.height === undefined) {
            this.ctx.drawImage(Img, Position.x, Position.y, (_a = this.ts.imageSize) === null || _a === void 0 ? void 0 : _a.width, (_b = this.ts.imageSize) === null || _b === void 0 ? void 0 : _b.height);
        }
        else {
            this.ctx.drawImage(Img, c.x, c.y, c.width, c.height, Position.x, Position.y, (_c = this.ts.imageSize) === null || _c === void 0 ? void 0 : _c.width, (_d = this.ts.imageSize) === null || _d === void 0 ? void 0 : _d.height);
        }
    }
    ...
    */
    ...
    Reset() {
        ...
        this.ctx.clearRect(0, 0, (_a = this.settings.size) === null || _a === void 0 ? void 0 : _a.width, (_b = this.settings.size) === null || _b === void 0 ? void 0 : _b.height);
        this.Defaults();
    }
    ...
    */
    GetImageData(Position = { x: 0, y: 0 }, Size = this.settings.size) {
        return this.ctx.getImageData(Position.x, Position.y, Size === null || Size === void 0 ? void 0 : Size.width, Size === null || Size === void 0 ? void 0 : Size.height);
    }
    ...
    */
    CreateImageData(Size = this.settings.size) {
        return this.ctx.createImageData(Size === null || Size === void 0 ? void 0 : Size.width, Size === null || Size === void 0 ? void 0 : Size.height);
    }
...
_CanvasRenderer_instances = new WeakSet(), _CanvasRenderer_SetValues = function _CanvasRenderer_SetValues(Settings) {
